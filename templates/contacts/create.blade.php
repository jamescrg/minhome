		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				...
				<select id="phone1_label" name="phone1_label" class="form-control">
					{% for  phoneLabels as phoneLabel  %}
                        <option	value="{{ phoneLabel }}" 
                            @if (old('phone1_label') == phoneLabel) selected
                            {% else %}if (contact.phone1_label == phoneLabel) selected 
                            {% endif %}>
                            {{ phoneLabel }}
                         </option>
          {% endforeach %}
				...
				<select id="phone2_label" name="phone2_label" class="form-control">
					{% for  phoneLabels as phoneLabel  %}
                        <option	value="{{ phoneLabel }}" 
                            ...
                            {% else %}if (contact.phone2_label == phoneLabel) selected 
                            {% endif %}>
                            {{ phoneLabel }}
                         </option>
					{% endforeach %}
				...
				<select id="phone3_label" name="phone3_label" class="form-control">
					{% for  phoneLabels as phoneLabel  %}
                        <option	value="{{ phoneLabel }}" 
                            ...
                            {% else %}if (contact.phone3_label == phoneLabel) selected 
                            {% endif %}>
                            {{ phoneLabel }}
                         </option>
					{% endforeach %}
